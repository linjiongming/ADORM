...
{
    public class EntityProjectTemplate : BaseTemplate, IProjectTemplate
    {
        public Guid ID { get; }

        public IEnumerable<EntitySchema> Entities { get; }

        public EntityProjectTemplate()
        {
            ID = Guid.NewGuid();
        }
...
<Project ToolsVersion=""15.0"" xmlns=""http://schemas.microsoft.com/developer/msbuild/2003"">
  ...
  <ItemGroup>
    <Compile Include=""{BaseEntityTemplate.ClassName}.cs"" />
    {string.Join("\r\n    ", Context.Entities.Select(x => $"<Compile Include=\"{x.Name}.cs\" />"))}
  </ItemGroup>
